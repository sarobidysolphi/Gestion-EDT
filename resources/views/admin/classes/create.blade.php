...
@section('content')
    <div style="max-width: 600px; margin: 0 auto;">
            <h1 style="color: #32CD32; text-align: center; margin-bottom: 20px;">Ajouter une Classe</h1>
    <div class="glass-form">
        <form action="{{ route('classes.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label>Niveau</label>
                <input type="text" name="niveau" placeholder="Ex: L1, L2..." required>
            </div>
    ...
    <style>
        /* --- CSS DU FORMULAIRE GLASS (Comme le Login) --- */
        .glass-form {
