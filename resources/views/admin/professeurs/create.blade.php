...
@section('content')
    <div style="max-width: 600px; margin: 0 auto;">
        <h1 style="color: #32CD32; text-align: center; margin-bottom: 20px;">Ajouter un Professeur</h1>
        <div class="glass-form">
            <form action="{{ route('professeurs.store') }}" method="POST">
                ...
                <div class="form-group">
                    <label>Prénoms</label>
                    <input type="text" name="Prenoms" placeholder="Ex: Jean" required>
                </div>

                <div class="form-group">
                    <label>Grade</label>
                    <input type="text" name="Grade" placeholder="Ex: Professeur" required>
                </div>
